...
public class EditingState extends AbstractState {
    ...
    public Result arraignment(Long activityId, Enum<Constants.ActivityState> currentState) {
        ...
        return isSuccess ? Result.buildResult(Constants.ResponseCode.SUCCESS, "活动提审成功") : Result.buildErrorResult("活动状态变更失败，原因：当前活动状态与之前状态不匹配");
    }
    ...
    public Result close(Long activityId, Enum<Constants.ActivityState> currentState) {
        ...
        return isSuccess ? Result.buildResult(Constants.ResponseCode.SUCCESS, "活动关闭成功") : Result.buildErrorResult("活动状态变更失败，原因：当前活动状态与之前状态不匹配");
    }
